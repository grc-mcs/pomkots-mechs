...
public class HoverUnitItemModel extends BasePartsItemModel<BasePartsItem.Extension> {
    @Override
    public ResourceLocation getModelResource(BasePartsItem.Extension animatable) {
        return new ResourceLocation(PomkotsMechs.MODID, "geo/hoverunit.geo.json");
    }
}
