...
public class WaveHorizontalEntity extends PomkotsThrowableProjectile implements GeoEntity, GeoAnimatable {
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);
    private static final int MAX_LIFE_TICKS = 40;
    private int lifeTicks = 0;

    public WaveHorizontalEntity(EntityType<? extends ThrowableProjectile> entityType, Level world) {
