...
public class Pms09EntityRenderer extends GeoEntityRenderer<Pms09Entity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pms09Entity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
