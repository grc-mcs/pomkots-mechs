...
public class Pmt04EntityRenderer extends GeoEntityRenderer<Pmt04Entity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pmt04Entity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
